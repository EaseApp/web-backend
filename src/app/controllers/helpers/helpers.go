...
func IsValidAppToken(username, tableName, appToken string) (*models.Application, bool) {
	app, err := querier.AuthenticateApplicationWithTableName(username, tableName, appToken)
	if err != nil {
		return app, false
	}
	return app, true
